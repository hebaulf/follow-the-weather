...
export default async (req, res) => {
  ...
  if (latitude === 'undefined' || longitude === 'undefined') {
    ...
    const urlComplete = `${baseUrl}/${longitude},${latitude}.json?&access_token="pk.eyJ1IjoiYXJuYXZhbGEiLCJhIjoiY2t3ZjM4Z2wzMGFtcjJ3bnU5ZDdhaHFmeCJ9.i-wJdflLC-HJCWPBXQL0JA"`
