...
export default async (req, res) => {
  ...
  const API_ENDPOINT = `https://api.mapbox.com/geocoding/v5/mapbox.places/${longitude},${latitude}.json?country=is&limit=1&types=place&language=en&access_token=${mapKey}`;
